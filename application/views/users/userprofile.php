			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
                        ...
                        <a href='<?php echo base_url('users/userprofile'); ?>' class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> User Profile <span class="badge"></span></a>
