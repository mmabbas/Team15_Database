            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href='<?php echo base_url('adminportal/viewCheckouts'); ?>' class="list-group-item"><span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span> Checkouts <span class="badge"><?php echo $checkOuts; ?> Active</span></a>
                        <a href='<?php echo base_url('adminportal/adminReservations'); ?>' class="list-group-item"><span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span> Reservations <span class="badge"><?php echo $reservations; ?> Active</span></a>
                    </div>
