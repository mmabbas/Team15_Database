...
<body>
    <div class="container box">
        <h1><?php echo $mostCheckedOut->itemName; ?></h1>
        <label>Is the most checked out item at the library, being checked out a total of <?php echo $mostCheckedOut->value_occurrence; ?> times.</label>
    </div>
    <div class="container box">
